...
class Parser:
	...
	def statement(self):
		...
		if res.error: return res.failure(InvalidSyntaxError(
			self.current_tok.pos_start, self.current_tok.pos_end,
			"Expected 'RETURN', 'SKIP', 'BREAK','VAL', 'CONST', 'IF', 'FOR', 'WHILE', 'FUNC', int, float, identifier, '+', '-', '(', '[' or 'INVER"
		))
	...
	def call(self):
		...
		if self.current_tok.type == TT_LPAREN:
			...
			if self.current_tok.type == TT_RPAREN:
				...
				if res.error:return res.failure(InvalidSyntaxError(
						self.current_tok.pos_start, self.current_tok.pos_end,
						"Expected ')', 'VAL', 'IF', 'FOR', 'WHILE', 'FUNC', int, float, identifier, '+', '-', '(' , '[' or 'INVER'"
					))
	...
	def expr(self):
		...
		if res.error: return res.failure(InvalidSyntaxError(
				self.current_tok.pos_start, self.current_tok.pos_end,
				"Expected 'VAL', 'CONST', 'IF', 'FOR', 'WHILE', 'FUNC', int, float, identifier, '+', '-', '(', '[' or 'INVER"
			))
